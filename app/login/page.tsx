      ...
      <div className="animate-fade-up relative z-10 w-full max-w-sm overflow-hidden rounded-2xl border border-border bg-surface shadow-lg">
        ...
        <div className="p-8">
          ...
          <button
            ...
            className="mb-5 flex w-full cursor-pointer items-center justify-center gap-3 rounded-lg border border-border bg-surface px-4 py-2.5 text-sm font-medium text-primary shadow-sm transition-all hover:bg-surface-raised hover:shadow-md"
          >
            <GoogleIcon />
